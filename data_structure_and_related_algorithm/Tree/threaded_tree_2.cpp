...
public:
    ...
    void in_visit(){
        ...
        while(!stk_.empty() || p != nullptr){
            ...
            if(pre != nullptr){
                pre->right = p;
                // cout << '*' << pre->data << "->" << pre->right->data << endl;
            }
            pre = p;
            p = p->right;
        }
    ...
    void thread_visit(char find_){
        BST_node* p, *pre = nullptr;
        if(root == nullptr)
            return;
        p = root;
        bool is_found = false;
        ...
        while(p) {
            if(find_ == p->data){
                ...
                if(p->right == nullptr)
                    ...
                    cout << p->right->data << p->right->r_;
                cout << endl << "prev is ";
                if(pre == nullptr)
                    cout << "NULL";
                else
                    cout << pre->data << pre->l_;
            }
            pre = p;
            p = p->right;
        }
